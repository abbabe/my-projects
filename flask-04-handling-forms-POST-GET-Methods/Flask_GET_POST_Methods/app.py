...
# create a function named "lcm" which calculates a least 
# common multiple values of two numbers. 
...
def calculate():
    if request.method == "POST":  # is imported request
        num1 = request.form.get("number1")
        num2 = request.form.get("number2")
        return render_template("result.html", result1 = num1, result2 = num2, lcm = lcm(int(num1),int(num2)), developer_name = 'abbabe')
    else:
        return render_template("result.html", developer_name = "abbabe")
